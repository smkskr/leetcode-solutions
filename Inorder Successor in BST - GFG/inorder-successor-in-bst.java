...
class Solution
{
    ...
    public Node inorderSuccessorUtil(Node root, Node x, Node succ){
        
          //add code here.
         if(root == null)return null;
         if(x.data < root.data){
             return inorderSuccessorUtil(root.left, x, root);
         }else if(x.data > root.data){
             return inorderSuccessorUtil(root.right, x, succ);
         }else{
             if(root.right == null){
                 return succ;
             }else{
                 return smallestValue(root.right);
             }
         }
    ...
    public Node smallestValue(Node root){
