...
{   
    ...
    // do inorder traversal again and compare the arraylist index
    // with the node and replace the node value 
    // with arraylist index value if both of them are not equal
